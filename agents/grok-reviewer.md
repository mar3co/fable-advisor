...

{
  ...
  echo "The diff below is the authoritative bytes under review. If files you read on"
  echo "disk disagree with it (the commit may not be checked out), trust the diff."
  echo
  echo "--- DIFF ---"
